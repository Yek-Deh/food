                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="category_id" class="form-select">
                                                ...
                                                @foreach ($category as $cat)
                                                    <option
                                                        value="{{ $cat->id }}" {{ $cat->id == $product->category_id ? 'selected' : '' }} >{{ $cat->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="menu_id" class="form-select">
                                                ...
                                                @foreach ($menu as $men)
                                                    <option
                                                        value="{{ $men->id }}" {{ $men->id == $product->menu_id ? 'selected' : '' }}>{{ $men->menu_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="city_id" class="form-select">
                                                ...
                                                @foreach ($city as $cit)
                                                    <option
                                                        value="{{ $cit->id }}" {{ $cit->id == $product->city_id ? 'selected' : '' }}>{{ $cit->city_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="client_id" class="form-select">
                                                ...
                                                @foreach ($client as $clie)
                                                    <option
                                                        value="{{ $clie->id }}" {{ $clie->id == $product->client_id ? 'selected' : '' }}>{{ $clie->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
