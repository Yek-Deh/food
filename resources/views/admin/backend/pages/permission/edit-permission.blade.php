                                        ...
                                        <div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="group_name" class="form-select">
                                                    ...
                                                    <option
                                                        value="City" {{ $permission->group_name == 'City' ? 'selected' : '' }}>
                                                        City
                                                    </option>
                                                    <option
                                                    ...
                                                    <option
                                                        value="Restaurant" {{ $permission->group_name == 'Restaurant' ? 'selected' : '' }}>
                                                        Restaurant
                                                    </option>
                                                    <option
                                                    ...
                                                    <option
                                                        value="Reports" {{ $permission->group_name == 'Reports' ? 'selected' : '' }}>
                                                        Reports
                                                    </option>
                                                    <option
