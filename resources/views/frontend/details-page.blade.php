...
@section('dashboard')
    ...
    <section class="restaurant-detailed-banner">
        <div class="text-center">
            <img class="img-fluid cover" src="{{asset('upload/client_images/' . $client->cover_photo)}}" alt="no-photo">
        </div>
    ...
    <section class="offer-dedicated-body pt-2 pb-2 mt-4 mb-4">
        <div class="container">
                    ...
                    <div class="offer-dedicated-body-left">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel"
                                ...
                                @php
                                    $populars = App\Models\Product::where('status',1)->where('client_id',$client->id)->where('most_popular',1)->orderBy('id','desc')->limit(5)->get();
                                @endphp
                      ...
                      <a class="btn btn-outline-secondary btn-sm" href="{{ route('add_to_cart',$popular->id)}}">ADD</a>
                     </span>
                                                    </a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="list-card-image">
                                                    ...
                                                    <a href="#">
                                                        <img src="{{ asset($bestseller->image) }}"
                                                             class="img-fluid item-img" alt="no photo">
                                                    </a>
                                                </div>
                            ...
                            <div class="tab-pane fade text-center" id="pills-gallery" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel"
                                ...
                                <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                                    ...
                                    <p class="mb-2 text-black"><i
                                            class="icofont-email text-primary mr-2"></i> {{ $client->email }}</p>
                                    <p class="mb-2 text-black"><i
                                            class="icofont-clock-time text-primary mr-2"></i> {{ $client->shop_info }}
                                        <span class="badge badge-success"> OPEN NOW </span>
                                    </p>
                                    <hr class="clearfix">
                                    <p class="text-black mb-0">You can also check the 3D view by using our menue map
                                        clicking here &nbsp;&nbsp;&nbsp; <a class="text-info font-weight-bold" href="#">Venue
                                            Map</a></p>
                                    <hr class="clearfix">
                              ...
                              <a href="#"><i class="icofont-ui-rating icofont-2x"></i></a>
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-4 clearfix graph-star-rating">
                                    ...
                                    <div class="graph-star-rating-footer text-center mt-3 mb-3">
                                        <button type="button" class="btn btn-outline-primary btn-sm">Rate and Review
                                        </button>
                                    </div>
                                </div>
                                <div
          ...
          <button class="btn btn-outline-danger btn-sm right remove" data-id="{{ $id }}"> <i class="icofont-trash"></i> </button>
                                        ...
                                        <div class="media">
                                            <div class="mr-2"><img src="{{ asset($details['image']) }}" width="25px">
                                            </div>
                                            <div class="media-body">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" type="submit" id="button-addon2"
                                                onclick="ApplyCoupon()"><i class="icofont-sale-discount"></i> APPLY
                                        </button>
                                    </div>
                                </div>
                            </div>
