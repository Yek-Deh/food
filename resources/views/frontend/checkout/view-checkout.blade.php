...
@section('dashboard')
                                ...
                                <div class="col-sm-8 pl-0">
                                    <div class="tab-content h-100" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-home" role="tabpanel"
                                            ...
                                            <p>WE ACCEPT <span class="osahan-card"><i class="icofont-visa-alt"></i> <i
                        ...
                        <div class="d-flex mb-4 osahan-cart-item-profile">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="mb-0 text-white"><i
                                        class="icofont-location-pin"></i> {{ $profileData->address }}</p>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51QA5dh088ZzCNUvJlxkiOsW6yKxmCtKGvbaEfO9R1ZSMQx60CUjDIQDDuuX4wpflqIyhFKR6sRMAuHEW4o2Ji6bv00KjJO6YAB');
